...
public class Login extends JFrame implements ActionListener{
	...
	Login(){
		...
		l1 = new JLabel("Username");//label name
		...
		tf1 = new JTextField(15);// text area: text field
		...
		b3.setBounds(330,200,130,20);
		add(b3);
		
		b1.addActionListener(this);// used methods to perform relevant events
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource() == b1) {
			try {
				...
				if(rs.next()) {//iterate over next row
